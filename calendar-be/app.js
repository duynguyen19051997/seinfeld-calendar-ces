...
const editUserRouter = require("./routes/editUserInfor");
const showViewCheckedRouter = require("./routes/showViewChecked");
...
app.use("/show_on_day", showCheckedOnDayRouter);
...
app.use("/show_view_checked", showViewCheckedRouter);
